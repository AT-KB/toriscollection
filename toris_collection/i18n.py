...
TRANSLATIONS: dict[str, str] = {
    ...
    # どの音を重ねるかを絵で選ぶ形にした。
    # 2026-08-11: 合成音をやめ Freesound の実録音(CC0)にしたのに合わせ、
    # タイルを 雨/風/小川/波 の**自然音4つ**に入れ替えた。
    # 「やわらか(pad)」はタイルを外して常時鳴る下地に、「風鈴」は自然音ではないので廃止。
    '風': 'Wind',
    '雨': 'Rain',
    '小川': 'Stream',
    '波': 'Waves',
    # 2026-08-13 追加(CEO 指定)。焚き火・洞窟の水滴・湖。
    '湖': 'Lake',
    '焚き火': 'Fire',
    '洞窟': 'Cave',
