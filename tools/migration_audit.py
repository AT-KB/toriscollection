...
REQUIRED_IN_UI = [
    ...
    # ラジオ(2026-08-21)。**会った鳥だけが鳴く**をエンジンが実際に使っているか。
    # 移植でこの絞り込みが落ち、初回から未観察の鳥が鳴いていた。
    ("toris_app/lib/radio/radio_engine.dart", r"observedInBiome",
     "ラジオが観察済みの鳥に絞っていない。会っていない鳥が最初から鳴く"),
]
